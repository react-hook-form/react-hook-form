...
describe('useFieldArray', () => {
  ...
  describe.only('with should unregister false', () => {
  ...
  //             <input
  //               key={item.id}
  //               ref={control.register(`test[${index}].nestedArray[${i}].value`)}
  ...
  //             <input
  //               key={item.id}
  //               ref={control.register(`nest[${index}].nestedArray[${i}].value`)}
  //               defaultValue={item.value}
  //             />
  //           ))}
  //         </div>
