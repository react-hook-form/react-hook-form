...
describe('useWatch', () => {
    ...
    it('should remove input with shouldUnregister: true and deeply nested', async () => {
        ...
        const Child = ({
            ...
            return (
                <>
                    {show && show !== 'test' && <input {...register('test')} />}
                </>
            );
        };
        ...
        it('should return undefined when input get unregistered', () => {
            ...
            const Component = () => {
                ...
                return (
                    <>
                        <Test control={control} />
                        <button onClick={() => unregister('test')}>
                            unregister
                        </button>
                    </>
                );
            ...
            function Item({
                ...
                return (
                    <div>
                        <input
                            {...register(
                                `labels.${itemIndex}.displayName` as const,
                            )}
    ...
    describe('fieldArray with shouldUnregister true', () => {
        it('should watch correct input update with single field array input', async () => {
            ...
            expect(
                await screen.findByText('Value 1: ShouldBeTHere'),
            ).toBeVisible();
