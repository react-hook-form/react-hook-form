...
describe('useFieldArrayNested', () => {
  it('should work correctly with nested field array', async () => {
    ...
    cy.expectContains('#touched-nested-2', '{"test":[{"firstName":true,"keyValue":[]},{"firstName":true},{"firstName":true},{"keyValue":[]}]}');
    ...
    await cy.click('#submit');
    cy.expectContains('#result', '{"test":[{"firstName":"prepend","keyValue":[]}]}');
