...
describe('useForm', () => {
    ...
    describe('handleChangeRef', () => {
        ...
        describe('with resolver', () => {
            ...
            it('with sync resolver it should contain error if value is invalid with resolver', async () => {
                ...
                await waitFor(() =>
                    expect(methods.formState.isValid).toBe(true),
                );
                expect(screen.getByRole('alert').textContent).toBe('');
    ...
    describe('control', () => {
        it('does not change across re-renders', () => {
            ...
            expect(Object.is(firstRenderControl, secondRenderControl)).toBe(
                true,
            );
        });
    });
