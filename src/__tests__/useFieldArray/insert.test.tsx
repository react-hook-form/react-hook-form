            ...
            return (
                <form>
                    ...
                    <button
                        type="button"
                        onClick={() =>
                            insert(1, { value: '' }, { shouldFocus: false })
                        }
                    >
                        insert
                    </button>
        ...
        function FieldArray({
            ...
            return (
                <>
                    ...
                    <button
                        type="button"
                        onClick={() => insert(0, itemDefaultValue)}
                    >
                        Append
                    </button>
                </>
