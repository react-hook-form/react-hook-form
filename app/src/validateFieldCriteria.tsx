...
const ValidateFieldCriteria: React.FC = () => {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {errors.minDate &&
                errors.minDate.types &&
                errors.minDate.types.min && <p>minDate min</p>}
            <input
                type="date"
            ...
            {errors.maxDate &&
                errors.maxDate.types &&
                errors.maxDate.types.max && <p>maxDate max</p>}
            <input
            ...
            {errors.selectNumber &&
                ...
                errors.selectNumber.types.required && (
                    <p>selectNumber required</p>
                )}
            {errors.selectNumber &&
                errors.selectNumber.types &&
                errors.selectNumber.types.minLength && (
                    <p>selectNumber minLength</p>
                )}
            <input
                {...register('pattern', {
                    pattern: /\d+/,
