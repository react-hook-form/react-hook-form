...
import UseFieldArrayWithExternalRHForm from './useFieldArrayWithExternalRHForm';
...
const App: React.FC = () => {
  return (
    <Router>
      ...
      />
      <Route
        path="/useFieldArrayWithExternalRHForm"
        exact
        component={UseFieldArrayWithExternalRHForm}
      />
