...
export type DeepMap<T, TValue> = IsAny<T> extends true
  ? any
  : T extends Date | FileList_2 | File_2 | NestedValue
  ? TValue
  : T extends object
  ? {
...
// @public (undocumented)
export type DeepPartial<T> = T extends Date | FileList_2 | File_2 | NestedValue
  ? T
  : {
...
export type IsFlatObject<T extends object> = Extract<
  Exclude<T[keyof T], NestedValue | Date | FileList_2>,
  any[] | object
> extends never
  ? true
  : false;
