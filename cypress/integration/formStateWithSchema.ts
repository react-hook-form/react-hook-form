context('form state with schema validation', () => {
  it('should return correct form state with onSubmit mode', () => {
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#submit').click();
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":true,"submitCount":1,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );

    cy.get('input[name="lastName"]').type('test');
    cy.get('#submit').click();
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":true,"submitCount":2,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );
  ...
  it('should return correct form state with onChange mode', () => {
    ...
    cy.get('input[name="lastName"]').blur();
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":true}',
    );
    ...
    cy.get('#submit').click();
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":true,"submitCount":2,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":true}',
    );
  ...
  it('should reset dirty value when inputs reset back to default with onSubmit mode', () => {
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox","checkbox-checked"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":{},"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox","checkbox-checked","radio"],"isSubmitting":false,"isValid":false}',
    );
