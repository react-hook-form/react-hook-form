context.skip('form state with schema validation', () => {
  it('should return correct form state with onSubmit mode', () => {
    ...
    cy.get('#submit').click();
    cy.get('#state').contains(
      '{"dirty":true,"dirtyFields":["firstName","lastName"],"isSubmitted":true,"submitCount":2,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );
