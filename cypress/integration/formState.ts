describe('form state', () => {
  it('should return correct form state with onSubmit mode', () => {
    ...
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["firstName"],"isSubmitted":false,"submitCount":0,"touched":["firstName"],"isSubmitting":false,"isValid":false}',
    );

    cy.get('input[name="firstName"]').clear();
    cy.get('#state').contains(
      '{"isDirty":false,"dirtyFields":[],"isSubmitted":false,"submitCount":0,"touched":["firstName"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["firstName","lastName"],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#submit').click();
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["firstName"],"isSubmitted":true,"submitCount":1,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":false}',
    );
  ...
  it('should return correct form state with onChange mode', () => {
    ...
    cy.get('input[name="lastName"]').blur();
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["firstName","lastName"],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName"],"isSubmitting":false,"isValid":true}',
    );
  ...
  it('should reset dirty value when inputs reset back to default with onSubmit mode', () => {
    ...
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["select"],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select"],"isSubmitting":false,"isValid":false}',
    );
    cy.get('select[name="select"]').select('test');
    cy.get('#state').contains(
      '{"isDirty":false,"dirtyFields":[],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select"],"isSubmitting":false,"isValid":false}',
    );

    cy.get('input[name="checkbox"]').check('on');
    cy.get('input[name="checkbox"]').blur();
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["checkbox"],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox"],"isSubmitting":false,"isValid":false}',
    );

    cy.get('input[name="checkbox"]').uncheck();
    cy.get('#state').contains(
      '{"isDirty":false,"dirtyFields":[],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox"],"isSubmitting":false,"isValid":false}',
    );
    ...
    cy.get('#state').contains(
      '{"isDirty":false,"dirtyFields":[],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox","checkbox-checked"],"isSubmitting":false,"isValid":false}',
    );

    cy.get('input[name="radio"]').check();
    cy.get('input[name="radio"]').blur();
    cy.get('#state').contains(
      '{"isDirty":true,"dirtyFields":["radio"],"isSubmitted":false,"submitCount":0,"touched":["firstName","lastName","select","checkbox","checkbox-checked","radio"],"isSubmitting":false,"isValid":false}',
    );
